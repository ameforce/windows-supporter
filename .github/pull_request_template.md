...
- [ ] 같은 exact base/head에서 독립 review를 먼저 통과(`P0=P1=P2=0`)한 뒤에만 `@codex review`를 호출했고, finding/결론을 서로 전달하지 않았음
...
- [ ] push 또는 base/head SHA 변경 시 기존 리뷰를 stale 처리하고 main Codex의 완성 판정 뒤 새 review key에서 독립 review를 먼저 다시 수행함
