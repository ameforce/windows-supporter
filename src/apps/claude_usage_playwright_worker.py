...
def run_claude_playwright_worker(connection: Connection) -> None:
    """Run Claude collection in the existing killable process boundary."""
    ...
    # bootstrap[3] is the shared worker protocol's cookie slot. Claude never
    ...
    driver = ClaudeUsagePlaywrightDriver(config, log_sink=emit_log)
    ...
    while True:
        ...
        try:
            ...
            emit_log(
                "claude browser worker command failed "
